  ...
  const confirmSave = async () => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/products`, {
        ...
        shipping_category: calculateDeliveryPrices(dimensions, weight).category,
        delivery_cost_webshop: deliveryCost.trim(),
        delivery_cost_size: `€${calculateDeliveryPrices(dimensions, weight).sizePrice.toFixed(2)}`,
        delivery_cost_weight: `€${calculateDeliveryPrices(dimensions, weight).weightPrice.toFixed(2)}`,
